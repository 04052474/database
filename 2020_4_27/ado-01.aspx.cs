...
public partial class ado_01 : System.Web.UI.Page
{
    ...
    {
        //註解：第一、連結SQL資料庫
        SqlConnection Conn = new SqlConnection("Data Source=AA201-35\\SQLEXPRESS;Initial Catalog=NORTHWND;User ID=test;Password=test");
        Conn.Open();
        ...
        SqlCommand cmd = new SqlCommand("Insert Into Employees (LastName,FirstName,Title,TitleOfCourtesy) " +
            "Values ('Lee','David', 'Sales Representative','Mr.') ", Conn);
        cmd.ExecuteNonQuery();
    ...
    protected void Button3_Click(object sender, EventArgs e)
    {
        ...
        //註解：第二、執行SQL指令，使用ExecuteNonQuery
        SqlCommand cmd = new SqlCommand("Delete From Employees Where EmployeeID='6' ", Conn);
        cmd.ExecuteNonQuery();
